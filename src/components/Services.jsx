...
const Services = () => (
  <section className="py-20 bg-gray-100">
    <h2 className="text-center text-4xl font-extrabold text-blue-700 mb-10">Our Services</h2>
    <div className="flex justify-center space-x-8">
      {services.map((service, index) => (
        <div key={index} className="bg-white p-6 rounded-lg shadow-lg max-w-sm text-center transform hover:scale-105 transition duration-300">
