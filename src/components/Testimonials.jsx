const Testimonials = () => (
  <section className="py-20 bg-gray-100">
    <h2 className="text-center text-3xl sm:text-4xl font-extrabold text-blue-700 mb-10">What Our Clients Say</h2>
    <div className="flex flex-col items-center space-y-6 max-w-3xl mx-auto px-4 sm:px-0">
      {[
